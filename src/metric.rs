///
pub static TIMES : [&[u16;149]; 4] = [&TIMES1, &TIMES2, &TIMES3, &TIMES4];

///
pub static HELVETICA : [&[u16;149]; 4] = [&HELVETICA1, &HELVETICA2, &HELVETICA3, &HELVETICA4 ];


static TIMES1 : [u16; 149] = [
