...
pub static TIMES0: [u16; 224] = [
    ...
    500, /* C 177 | WX */ 500, /* | N  endash | B 0 201 500 250 ; */
    ...
    500, /* C 182 | WX */ 453, /* | N  paragraph | B -22 -154 450 662 ; */
    ...
    500, /* C 191 | WX */ 444, /* | N  questiondown | B 30 -218 376 466 ; */
    500, /* C 193 | WX */ 333, /* | N  grave | B 19 507 242 678 ; */
    ...
    500, /* C 202 | WX */ 333, /* | N  ring | B 67 512 266 711 ; */
    /* C 203 | WX */ 333, /* | N  cedilla | B 52 -215 261 0 ; */
    500, /* C 205 | WX */ 333, /* | N  hungarumlaut | B -3 507 377 678 ; */
    ...
    500, /* C 227 | WX */ 276, /* | N  ordfeminine | B 4 394 270 676 ; */
    500, 500, 500, 500, /* C 232 | WX */ 611, /* | N  Lslash | B 12 0 598 662 ; */
    /* C 233 | WX */ 722, /* | N  Oslash | B 34 -80 688 734 ; */
    /* C 234 | WX */ 889, /* | N  OE | B 30 -6 885 668 ; */
    /* C 235 | WX */ 310, /* | N  ordmasculine | B 6 394 304 676 ; */
    500, 500, 500, 500, 500, /* C 241 | WX */ 667, /* | N  ae | B 38 -10 632 460 ; */
    500, 500, 500, /* C 245 | WX */ 278, /* | N  dotlessi | B 16 0 253 460 ; */
    500, 500, /* C 248 | WX */ 278, /* | N  lslash | B 19 0 259 683 ; */
...
pub static TIMES1: [u16; 224] = [
    ...
    500, /* C 177 ; WX */ 500, /* N endash $ B 0 181 500 271 ; */
    ...
    500, /* C 182 ; WX */ 540, /* N paragraph $ B 0 -186 519 676 ; */
    ...
    500, /* C 191 ; WX */ 500, /* N questiondown $ B 55 -201 443 501 ; */
    500, /* C 193 ; WX */ 333, /* N grave $ B 8 528 246 713 ; */
    ...
    500, /* C 202 ; WX */ 333, /* N ring $ B 60 527 273 740 ; */
    ...
    500, /* C 227 ; WX */ 300, /* N ordfeminine $ B -1 397 301 688 ; */
    500, 500, 500, 500, /* C 232 ; WX */ 667, /* N Lslash $ B 19 0 638 676 ; */
    /* C 233 ; WX */ 778, /* N Oslash $ B 35 -74 743 737 ; */
    /* C 234 ; WX */ 1000, /* N OE $ B 22 -5 981 684 ; */
    /* C 235 ; WX */ 330, /* N ordmasculine $ B 18 397 312 688 ; */
    500, 500, 500, 500, 500, /* C 241 ; WX */ 722, /* N ae $ B 33 -14 693 473 ; */
    500, 500, 500, /* C 245 ; WX */ 278, /* N dotlessi $ B 16 0 255 461 ; */
    500, 500, /* C 248 ; WX */ 278, /* N lslash $ B -22 0 303 676 ; */
...
pub static TIMES2: [u16; 224] = [
    ...
    500, /* C 177 , WX */ 500, /* , Nendash , B -6 197 505 243 ; */
    ...
    500, /* C 183 , WX */ 350, /* , Nbullet , B 40 191 310 461 ; */
    ...
    500, /* C 191 , WX */ 500, /* , Nquestiondown , B 28 -205 368 471 ; */
    500, /* C 193 , WX */ 333, /* , Ngrave , B 121 492 311 664 ; */
    ...
    500, /* C 202 , WX */ 333, /* , Nring , B 155 492 355 691 ; */
    /* C 203 , WX */ 333, /* , Ncedilla , B -30 -217 182 0 ; */
    500, /* C 205 , WX */ 333, /* , Nhungarumlaut , B 93 494 486 664 ; */
    ...
    500, /* C 227 , WX */ 276, /* , Nordfeminine , B 42 406 352 676 ; */
    500, 500, 500, 500, /* C 232 , WX */ 556, /* , NLslash , B -8 0 559 653 ; */
    /* C 233 , WX */ 722, /* , NOslash , B 60 -105 699 722 ; */
    /* C 234 , WX */ 944, /* , NOE , B 49 -8 964 666 ; */
    /* C 235 , WX */ 310, /* , Nordmasculine , B 67 406 362 676 ; */
    500, 500, 500, 500, 500, /* C 241 , WX */ 667, /* , Nae , B 23 -11 640 441 ; */
    500, 500, 500, /* C 245 , WX */ 278, /* , Ndotlessi , B 49 -11 235 441 ; */
    500, 500, /* C 248 , WX */ 278, /* , Nlslash , B 41 -11 312 683 ; */
...
pub static TIMES3: [u16; 224] = [
    ...
    500, /* C 177 , WX */ 500, /* , Nendash , B -40 178 477 269 ; */
    ...
    500, /* C 182 , WX */ 500, /* , Nparagraph , B -57 -193 562 669 ; */
    ...
    500, /* C 191 , WX */ 500, /* , Nquestiondown , B 30 -205 421 492 ; */
    500, /* C 193 , WX */ 333, /* , Ngrave , B 85 516 297 697 ; */
    ...
    500, /* C 202 , WX */ 333, /* , Nring , B 127 516 340 729 ; */
    /* C 203 , WX */ 333, /* , Ncedilla , B -80 -218 156 5 ; */
    500, /* C 205 , WX */ 333, /* , Nhungarumlaut , B 69 516 498 697 ; */
    ...
    500, /* C 227 , WX */ 266, /* , Nordfeminine , B 16 399 330 685 ; */
    500, 500, 500, 500, /* C 232 , WX */ 611, /* , NLslash , B -22 0 590 669 ; */
    /* C 233 , WX */ 722, /* , NOslash , B 27 -125 691 764 ; */
    /* C 234 , WX */ 944, /* , NOE , B 23 -8 946 677 ; */
    /* C 235 , WX */ 300, /* , Nordmasculine , B 56 400 347 685 ; */
    500, 500, 500, 500, 500, /* C 241 , WX */ 722, /* , Nae , B -5 -13 673 462 ; */
    500, 500, 500, /* C 245 , WX */ 278, /* , Ndotlessi , B 2 -9 238 462 ; */
    500, 500, /* C 248 , WX */ 278, /* , Nlslash , B -7 -9 307 699 ; */
...
pub static HELVETICA0: [u16; 224] = [
    ...
    /* C 96 , WX */ 333, /*222*/
    /* , N  quoteleft , B 65 470 169 725 ; */
    /* C 97 , WX */
    556, /* , N  a , B 36 -15 530 538 ; */
    ...
    500, /* C 177 , WX */ 556, /* , N  endash , B 0 240 556 313 ; */
    ...
    500, /* C 182 , WX */ 537, /* , N  paragraph , B 18 -173 497 718 ; */
    ...
    500, /* C 191 , WX */ 611, /* , N  questiondown , B 91 -201 527 525 ; */
    500, /* C 193 , WX */ 333, /* , N  grave , B 14 593 211 734 ; */
    ...
    500, /* C 202 , WX */ 333, /* , N  ring , B 75 572 259 756 ; */
    /* C 203 , WX */ 333, /* , N  cedilla , B 45 -225 259 0 ; */
    500, /* C 205 , WX */ 333, /* , N  hungarumlaut , B 31 593 409 734 ; */
    ...
    500, /* C 227 , WX */ 370, /* , N  ordfeminine , B 24 405 346 737 ; */
    500, 500, 500, 500, /* C 232 , WX */ 556, /* , N  Lslash , B -20 0 537 718 ; */
    /* C 233 , WX */ 778, /* , N  Oslash , B 39 -19 740 737 ; */
    /* C 234 , WX */ 1000, /* , N  OE , B 36 -19 965 737 ; */
    /* C 235 , WX */ 365, /* , N  ordmasculine , B 25 405 341 737 ; */
    500, 500, 500, 500, 500, /* C 241 , WX */ 889, /* , N  ae , B 36 -15 847 538 ; */
    500, 500, 500, /* C 245 , WX */ 278, /* , N  dotlessi , B 95 0 183 523 ; */
    500, 500, /* C 248 , WX */ 222, /* , N  lslash , B -20 0 242 718 ; */
...
pub static HELVETICA1: [u16; 224] = [
    ...
    /* C 95 , WX */ 556, /* , N  underscore , B 0 -125 556 -75 ; */
    /* C 96 , WX */ 333, /*278*/
    /* , N  quoteleft , B 69 454 209 727 ; */
    /* C 97 , WX */
    556, /* , N  a , B 29 -14 527 546 ; */
    ...
    500, /* C 177 , WX */ 556, /* , N  endash , B 0 227 556 333 ; */
    ...
    500, /* C 182 , WX */ 556, /* , N  paragraph , B -8 -191 539 700 ; */
    ...
    500, /* C 191 , WX */ 611, /* , N  questiondown , B 55 -195 551 532 ; */
    500, /* C 193 , WX */ 333, /* , N  grave , B -23 604 225 750 ; */
    ...
    500, /* C 202 , WX */ 333, /* , N  ring , B 59 568 275 776 ; */
    /* C 203 , WX */ 333, /* , N  cedilla , B 6 -228 245 0 ; */
    500, /* C 205 , WX */ 333, /* , N  hungarumlaut , B 9 604 486 750 ; */
    ...
    500, /* C 227 , WX */ 370, /* , N  ordfeminine , B 22 401 347 737 ; */
    500, 500, 500, 500, /* C 232 , WX */ 611, /* , N  Lslash , B -20 0 583 718 ; */
    /* C 233 , WX */ 778, /* , N  Oslash , B 33 -27 744 745 ; */
    /* C 234 , WX */ 1000, /* , N  OE , B 37 -19 961 737 ; */
    /* C 235 , WX */ 365, /* , N  ordmasculine , B 6 401 360 737 ; */
    500, 500, 500, 500, 500, /* C 241 , WX */ 889, /* , N  ae , B 29 -14 858 546 ; */
    500, 500, 500, /* C 245 , WX */ 278, /* , N  dotlessi , B 69 0 209 532 ; */
    500, 500, /* C 248 , WX */ 278, /* , N  lslash , B -18 0 296 718 ; */
...
pub static HELVETICA2: [u16; 224] = [
    ...
    /* C 96 , WX */ 333, /*222*/
    /* , N  quoteleft , B 165 470 323 725 ; */
    /* C 97 , WX */
    556, /* , N  a , B 61 -15 559 538 ; */
    ...
    500, /* C 177 , WX */ 556, /* , N  endash , B 51 240 623 313 ; */
    ...
    500, /* C 182 , WX */ 537, /* , N  paragraph , B 126 -173 650 718 ; */
    ...
    500, /* C 191 , WX */ 611, /* , N  questiondown , B 85 -201 534 525 ; */
    500, /* C 193 , WX */ 333, /* , N  grave , B 170 593 337 734 ; */
    ...
    500, /* C 202 , WX */ 333, /* , N  ring , B 214 572 402 756 ; */
    /* C 203 , WX */ 333, /* , N  cedilla , B 2 -225 232 0 ; */
    500, /* C 205 , WX */ 333, /* , N  hungarumlaut , B 157 593 565 734 ; */
    ...
    500, /* C 227 , WX */ 370, /* , N  ordfeminine , B 127 405 449 737 ; */
    500, 500, 500, 500, /* C 232 , WX */ 556, /* , N  Lslash , B 41 0 555 718 ; */
    /* C 233 , WX */ 778, /* , N  Oslash , B 43 -19 890 737 ; */
    /* C 234 , WX */ 1000, /* , N  OE , B 98 -19 1116 737 ; */
    /* C 235 , WX */ 365, /* , N  ordmasculine , B 141 405 468 737 ; */
    500, 500, 500, 500, 500, /* C 241 , WX */ 889, /* , N  ae , B 61 -15 909 538 ; */
    500, 500, 500, /* C 245 , WX */ 278, /* , N  dotlessi , B 95 0 294 523 ; */
    500, 500, /* C 248 , WX */ 222, /* , N  lslash , B 41 0 347 718 ; */
...
pub static HELVETICA3: [u16; 224] = [
    ...
    /* C 95 , WX */ 556, /* , N  underscore , B -27 -125 540 -75 ; */
    /* C 96 , WX */ 333, /*278*/
    /* , N  quoteleft , B 165 454 361 727 ; */
    /* C 97 , WX */
    556, /* , N  a , B 55 -14 583 546 ; */
    ...
    500, /* C 177 , WX */ 556, /* , N  endash , B 48 227 627 333 ; */
    ...
    500, /* C 182 , WX */ 556, /* , N  paragraph , B 98 -191 688 700 ; */
    ...
    500, /* C 191 , WX */ 611, /* , N  questiondown , B 53 -195 559 532 ; */
    500, /* C 193 , WX */ 333, /* , N  grave , B 136 604 353 750 ; */
    ...
    500, /* C 202 , WX */ 333, /* , N  ring , B 200 568 420 776 ; */
    /* C 203 , WX */ 333, /* , N  cedilla , B -37 -228 220 0 ; */
    500, /* C 205 , WX */ 333, /* , N  hungarumlaut , B 137 604 645 750 ; */
    ...
    500, /* C 227 , WX */ 370, /* , N  ordfeminine , B 125 401 465 737 ; */
    500, 500, 500, 500, /* C 232 , WX */ 611, /* , N  Lslash , B 34 0 611 718 ; */
    /* C 233 , WX */ 778, /* , N  Oslash , B 35 -27 894 745 ; */
    /* C 234 , WX */ 1000, /* , N  OE , B 99 -19 1114 737 ; */
    /* C 235 , WX */ 365, /* , N  ordmasculine , B 123 401 485 737 ; */
    500, 500, 500, 500, 500, /* C 241 , WX */ 889, /* , N  ae , B 56 -14 923 546 ; */
    500, 500, 500, /* C 245 , WX */ 278, /* , N  dotlessi , B 69 0 322 532 ; */
    500, 500, /* C 248 , WX */ 278, /* , N  lslash , B 40 0 407 718 ; */
...
pub static SYMBOL: [u16; 224] = [
    ...
    500, /* C 241 , WX */ 329, /* , N  angleright , B 21 -198 302 746 ; */
